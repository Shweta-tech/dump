...
def brestfed(request):    
    if request.method == 'POST':
        ...
        child_id = childreg.objects.get(child_id=cid)
        mid =request.POST.get('mother_id')
        mother_id =predlvry.objects.get(mother_id=mid)
        ...
        return render(request,"forms/index.html",{'child': childreg.objects.all(),'mother':predlvry.objects.all()})
...
def immunization(request):       
    if request.method == 'POST':
        ...
        # child_name = childreg.objects.get(cname=child_name)
        ...
        return render(request,"forms/immunization.html",{'child': childreg.objects.all(),'mother':predlvry.objects.all()})
...
def zerotosixmonth(request):       
    if request.method == 'POST':
        ...
        return render(request,"forms/zerotosixmonths.html",{'child': childreg.objects.all(),'mother':predlvry.objects.all()})
...
def sixtothreeyear(request):       
    if request.method == 'POST':
        ...
        return render(request,"forms/sixtotwothree.html",{'child': childreg.objects.all(),'mother':predlvry.objects.all()})
...
def home_visit(request):       
    if request.method == 'POST':
        ...
        return render(request,"forms/homevisit.html",{'child': childreg.objects.all()})
